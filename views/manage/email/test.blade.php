  ...
  <div class="hstui-frame">
    <div class="hstui-frame-content">
      ...
      <div class="hstui-form-group hstui-form-group-sm @if($errors->has('toemail')) hstui-form-error @endif" id="J_form_error_toemail">
        <label class="hstui-u-sm-2 hstui-form-label">{{ hst_lang('hstcms::manage.email.toemail') }}</label>
        <div class="hstui-u-sm-10 hstui-form-input">
            <input type="text" name="toemail" id="hstcms_toemail" value="@if($errors->has('toemail')){!! old('toemail') !!}@endif" class="hstui-input hstui-length-5 J_email_match">
            <div class="hstui-form-input-tips" id="J_form_tips_toemail" data-tips=""></div>
        </div>
      </div>
      <div class="hstui-form-group hstui-form-group-sm">
        <label class="hstui-u-sm-2 hstui-form-label">{!! hst_lang('hstcms::manage.email.content') !!}</label>
        <div class="hstui-u-sm-10 hstui-form-input">
    ...
    <div class="hstui-form-button">
       <button type="submit" class="hstui-button hstui-button-primary J_ajax_submit_btn">{{ hst_lang('hstcms::public.send') }}</button>
    </div>  
</form>
</div>
<script>
