...
<form method="post" class="hstui-form hstui-form-horizontal J_ajaxForm" action="{{ route('manageHookAddSave') }}">
    {{ hst_csrf() }}
    <div class="hstui-frame">
      <div class="hstui-frame-content">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('description')) hstui-form-error @endif" id="J_form_error_description">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="description" id="hstcms_description" value="{{ hst_value('description') }}" class="hstui-input hstui-length-4">
