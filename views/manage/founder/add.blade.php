...
<form method="post" class="J_ajaxForm" action="{{ route('manageFounderAddSave') }}">
    {{ hst_csrf() }}
    <div class="hstui-pop-cont hstui-pop-table">
        <div class="hstui-form hstui-form-horizontal">
            ...
            <div class="hstui-form-group" id="J_form_error_name">
                ...
                <input type="text" name="name" id="hstcms_name" class="hstui-form-field hstui-length-4" value="{{ hst_value('name') }}" placeholder="{{ hst_lang('hstcms::public.enter.one.realname') }}">
            </div>
