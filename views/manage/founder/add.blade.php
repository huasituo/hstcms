...
<body style="width: 650px; height: 555px">
<form method="post" class="hstui-form hstui-form-horizontal J_ajaxForm" action="{{ route('manageFounderAddSave') }}">
    {{ hst_csrf() }}
      ...
      <div class="hstui-frame-content">
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('username')) hstui-form-error @endif" id="J_form_error_username">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="username" id="hstcms_username" value="{{ hst_value('username') }}" class="hstui-input hstui-length-4">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('password')) hstui-form-error @endif" id="J_form_error_password">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="password" id="hstcms_password" value="{{ hst_value('password') }}" class="hstui-input hstui-length-4">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('mobile')) hstui-form-error @endif" id="J_form_error_mobile">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="mobile" id="hstcms_mobile" value="{{ hst_value('mobile') }}" class="hstui-input hstui-length-4">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('email')) hstui-form-error @endif" id="J_form_error_email">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="email" id="hstcms_email" value="{{ hst_value('email') }}" class="hstui-input hstui-length-4">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('qq')) hstui-form-error @endif" id="J_form_error_qq">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="qq" id="hstcms_qq" value="{{ hst_value('qq') }}" class="hstui-input hstui-length-4">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('weixin')) hstui-form-error @endif" id="J_form_error_weixin">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="weixin" id="hstcms_weixin" value="{{ hst_value('email') }}" class="hstui-input hstui-length-4">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('status')) hstui-form-error @endif" id="J_form_error_status">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
            <input type="checkbox" name="status" id="hstcms_status" data-class="hstui-switchx-default hstui-round hstui-mr-lg" data-switchx-offtext="{{ hst_lang('hstcms::public.disable')}}" data-switchx-ontext="{{ hst_lang('hstcms::public.enable')}}" data-hstui-switchx checked data-switchx-text="status"/>
