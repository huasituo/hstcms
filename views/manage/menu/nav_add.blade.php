...
<form method="post" class="hstui-form hstui-form-horizontal J_ajaxForm" action="{{ route('manageMenuNavAddSave') }}">
    {{ hst_csrf() }}
    <div class="hstui-frame">
      <div class="hstui-frame-content">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('ename')) hstui-form-error @endif" id="J_form_error_ename">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="ename" id="hstcms_ename" value="{{ hst_value('ename') }}" class="hstui-input hstui-length-4">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('url')) hstui-form-error @endif" id="J_form_error_url">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="url" id="hstcms_url" value="{{ hst_value('url') }}" class="hstui-input hstui-length-4">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('icon')) hstui-form-error @endif" id="J_form_error_icon">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="icon" id="hstcms_icon" value="{{ hst_value('icon') }}" class="hstui-input hstui-length-4">
