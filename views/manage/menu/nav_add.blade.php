...
<form method="post" class="J_ajaxForm" action="{{ route('manageMenuNavAddSave') }}">
    {{ hst_csrf() }}
        ...
        <div class="hstui-form hstui-form-horizontal">
            <div class="hstui-form-group" id="J_form_error_parent">
                ...
                <select class="hstui-length-4" name="parent" id="hstcms_parent">
                    <option value="0">{!! hst_lang('hstcms::public.top.level') !!}</option>
            ...
            <div class="hstui-form-group" id="J_form_error_name">
                ...
                <input type="text" name="name" id="hstcms_name" class="hstui-form-field hstui-length-4" value="{{ hst_value('name') }}" placeholder="{{ hst_lang('hstcms::public.enter.one.name') }}">
            </div>
            <div class="hstui-form-group" id="J_form_error_ename">
                ...
                <input type="text" name="ename" id="hstcms_ename" class="hstui-form-field hstui-length-4" value="{{ hst_value('ename') }}" placeholder="{{ hst_lang('hstcms::public.enter.one.ename') }}">
            </div>
            <div class="hstui-form-group" id="J_form_error_url">
                ...
                <input type="text" name="url" id="hstcms_url" class="hstui-form-field hstui-length-4" value="{{ hst_value('url') }}" placeholder="{{ hst_lang('hstcms::public.enter.one.url') }}">
            </div>
            <div class="hstui-form-group" id="J_form_error_icon">
                <label for="doc-ipt-pwd-21" class="hstui-u-sm-3 hstui-form-label">Icon</label>
                <input type="text" name="icon" id="hstcms_icon" class="hstui-form-field hstui-length-4" value="{{ hst_value('icon') }}" placeholder="{{ hst_lang('hstcms::public.enter.one.icon') }}">
            </div>
        </div>
    </div>
