...
class HstcmsEncrypter implements EncrypterContract
{
    /**
     * The encryption key.
     *
    ...
    public function decrypt($payload, $unserialize = false)
    {
        ...
        if ($decrypted === false) {
            ...
            return hst_message('Could not decrypt the data.', 'error');
        }
        if(isset($payload['sl'])) {
    ...
    protected function getJsonPayload($payload)
    {
        ...
        if (! $this->validMac($payload)) {
            ...
            return hst_message('The MAC is invalid.', 'error');
        }
