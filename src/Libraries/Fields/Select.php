...
class Select extends FieldAbs {
    ...
    {
		parent::__construct();
		$this->name = hst_lang('hstcms::fields.select'); // 字段名称
		...
		return '
			<div class="hstui-form-group hstui-form-group-sm">
	          ...
	          <div class="hstui-u-sm-10 hstui-form-input">
	            ...
	            <div class="hstui-form-input-tips" id="J_form_tips_name">'.hst_lang('hstcms::fields.select.list.tips').'</div>
	          </div>
	        </div>
	...
	public function output_data($data, $field = []) 
	{
		...
		$data[$field['fieldname']] = $_options[$value];
		return $data;
	}
}